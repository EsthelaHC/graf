import glfw
from OpenGL.GL import glClear, glClearColor, glBegin, glEnd, glVertex2f, glColor3f, GL_COLOR_BUFFER_BIT, GL_TRIANGLES, glOrtho

def draw_square():
    glBegin(GL_TRIANGLES)
    glColor3f(1.0, 1.0, 1.0)  # Color rojo
