...
# Variables globales
window = None
angle_x, angle_y, angle_z = 0, 0, 0  # Ángulos de rotación en los ejes X e Y
...
def draw_cube():
    ...
    glRotatef(angle_z, 0, 0, 1)   # Rotar el cubo en el eje z
...
def mouse_callback(window, xpos, ypos
    ...
    global angle_x, angle_y, angle_z, last_x, last_y
